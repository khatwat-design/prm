    ...
    <>
      ...
      >
        <div className="flex flex-col py-3">
          ...
          <button
            type="button"
            onClick={() => { onAddClient(); setMobileMenuOpen(false); }}
            className="flex items-center gap-3 px-4 py-3 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 text-right w-full"
          >
